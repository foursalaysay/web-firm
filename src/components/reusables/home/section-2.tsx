...
export default function Section2() {
  return (
    <div className="mb-5 lg:mb-20 w-[350px] lg:w-full h-[710px] lg:h-[588px] backdrop-blur-sm rounded-md pt-5 lg:p-5 flex flex-col lg:flex-row items-center justify-start lg:justify-center gap-5 bg-[url('/section2/new-2.jpg')] ">
       <Image
